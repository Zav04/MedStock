...
def login_page(page: ft.Page):
    ...
    login_button = ft.ElevatedButton(text="Login", on_click=lambda _:login_button_clicked(email_input, password_input))
    reset_password_text = ft.TextButton(text="Esqueci-me da Palavra-Passe", on_click=lambda _:reset_password_button_clicked)
    registar_text = ft.TextButton(text="Registar", on_click=lambda _:register_button_clicked)
