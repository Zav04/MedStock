  ...
  useEffect(() => {
    const fetchFornecedores = async () => {
      try {
        ...
        const fornecedorVacina = fornecedoresData.find(fornecedor => fornecedor.categoria === 'Descartáveis'); 
  ...
  return (
    <div className="grid-container">
      ...
      <div key={fornecedor.id} className="grid-item">
        ...
        <Link to={`./Descartaveis`}>Ver Detalhes</Link>
      </div>
    </div>
  );
};

export default CardDescartaveis;
